...
parser.add_argument('-vmax', '--vmax', default=10.0, type=float,
...
#************************
radmc3d = '/home/tubal/Repositorio/radmc3d-2.0/src/radmc3d'
workdir = './'
...
if args.radmc3d: ####COMMAND TO MAKE IMAGE#####
    #Es correcto mezclar simplemente la distibución lamb#
    subprocess.run('%s image iline 110 widthkms %.1f linenlam %d npix %d sizeau %.1f incl %.1f'%(radmc3d, args.vmax, args.nchan, args.nx, args.sizeau, args.incl), shell=True) #sizeau=2*xmax
    #subprocess.run('%s image lambdarange 1290.022317 1290.108298 nlam %d npix %d sizeau %.1f incl %.1f'%(radmc3d, args.nchan, args.nx, args.sizeau, args.incl), shell=True) #sizeau=2*xmax
