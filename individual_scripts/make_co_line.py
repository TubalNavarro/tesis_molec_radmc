...
if args.radmc3d:
    subprocess.run('%s image iline 2 widthkms %.1f linenlam %d npix %d sizeau %.1f incl %.1f'%(radmc3d, args.vmax, args.nchan, args.nx, args.sizeau, args.incl), shell=True) #sizeau=2*xmax
