...
class radmc3dImage(object):
    ...
    def readImage(self, fname=None, binary=False, old=False, dpc=1.0): #12Feb2024: dpc added by andizq
        ...
        conv = self.sizepix_x * self.sizepix_y / (dpc * nc.pc)**2. * 1e23 #12Feb2024: dpc added by andizq 
...
def readImage(fname=None, binary=False, old=False, dpc=1.0): #12Feb2024: dpc added by andizq
    """Reads an image calculated by RADMC-3D.
